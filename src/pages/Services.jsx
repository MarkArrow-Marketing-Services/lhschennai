...
export default function Services() {
  useEffect(() => {
    document.title =
      "Medical Services | London Harley Street Women & Fertility Centre";
  }, []);
  ...
  return (
    <div className="services-page" style={{ marginTop: "80px" }}>
      ...
      <section className="page-hero">
        <div className="container">
          ...
          <p>
            ...
            services. Discover our comprehensive range of specialized clinical
            programs.
          </p>
        </div>
      </section>
      ...
      <section className="section" style={{ background: "var(--white)" }}>
        <div className="container">
          <SectionTitle title="Core Medical Disciplines" />
      ...
      <section className="section section-alt">
        <div className="container">
          <SectionTitle title="All Specialized Healthcare Programs" />
      ...
      <section className="section" style={{ background: "var(--white)" }}>
        <div className="container">
          <SectionTitle title="Search Insights & Clinical Keywords" />
          <div
            style={{
              display: "flex",
              flexWrap: "wrap",
