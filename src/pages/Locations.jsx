...
export default function Locations() {
  useEffect(() => {
    document.title =
      "Our Locations | London Harley Street Women & Fertility Centre";
  }, []);
    ...
    <div className="locations-page" style={{ marginTop: "80px" }}>
      ...
      >
        <div className="container">
          ...
          >
            London Harley Street Women & Fertility Centre has established
            state-of-the-art facilities in Perungudi and Thalambur to provide
              ...
              <div key={idx} className="location-item-card">
                <div className="grid-12 align-center">
                  <div className="col-7">
                    ...
                    >
                      The facilities are designed to provide comfort, privacy,
                      and safety, ensuring a positive healthcare experience for
                      every patient. From regular check-ups to complex fertility
                      procedures, our centre maintains the international
                      standards in hygiene and clinical excellence.
                    </p>
                    <div
                    ...
                    >
                      ...
                      <div className="flex align-center gap-2">
                        ...
                        >
                          International Standards Hygiene
                        </span>
                      </div>
                    </div>
                  </div>
