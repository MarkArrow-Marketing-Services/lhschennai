...
import { ChevronRight, ArrowLeft, HeartPulse, CheckCircle2 } from "lucide-react";
...
const subServiceMapping = {
  ...
  "advanced-ultrasound-fetal-medical-services": "pregnancy-scans-advanced-ultrasound",
...
const subServiceTitles = {
  ...
  "advanced-ultrasound-fetal-medical-services": "Advanced Ultrasound & Fetal Medical Services",
...
export default function ServiceDetail() {
      ...
      <div className="service-detail-page" style={{ marginTop: "80px" }}>
        ...
        <section style={{
          ...
          <div className="container">
            <Link to="/services" className="flex align-center gap-1" style={{ marginBottom: "1.5rem", display: "inline-flex", fontWeight: "500" }}>
            ...
            <p style={{ fontSize: "1.1rem", color: "var(--body-text)", maxWidth: "700px", marginTop: "1rem" }}>
            ...
            <div className="grid-12">
              <div className="col-8">
                <div style={{ paddingRight: "2rem" }}>
                  <p style={{ fontSize: "1.1rem", lineHeight: "1.8", color: "var(--dark-text)", marginBottom: "1.5rem" }}>
                    At London Harley Street Women & Fertility Centre, we offer private, compassionate, and expert consultation for couples and individuals looking for family planning advice and medical sterilisation options.
                  </p>
                  <p style={{ fontSize: "1rem", lineHeight: "1.8", color: "var(--body-text)", marginBottom: "2rem" }}>
                    Choosing the right contraceptive method or exploring permanent sterilisation procedures is an important decision. Our specialists discuss medical history, lifestyle preferences, and reproductive health states to provide tailored guidelines.
                  </p>
                  
                  <h3 style={{ fontFamily: "var(--font-heading)", fontSize: "1.5rem", color: "var(--primary)", marginBottom: "1.5rem" }}>
                    Associated Clinical Focus
                  </h3>
                  <div className="flex flex-col gap-3">
                    <div className="flex align-center gap-2">
                      <CheckCircle2 size={18} color="var(--primary)" />
                      <span>Complete birth control counseling & prescription plans</span>
                    </div>
                    <div className="flex align-center gap-2">
                      <CheckCircle2 size={18} color="var(--primary)" />
                      <span>Temporary barrier & hormonal contraception options</span>
                    </div>
                    <div className="flex align-center gap-2">
                      <CheckCircle2 size={18} color="var(--primary)" />
                      <span>Laparoscopic permanent sterilisation consultations</span>
                    </div>
                    <div className="flex align-center gap-2">
                      <CheckCircle2 size={18} color="var(--primary)" />
                      <span>Post-sterilization counseling & recovery tracking</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="col-4">
                <div style={{
                  ...
                  <p style={{ fontSize: "0.9rem", color: "var(--body-text)", marginBottom: "2rem", lineHeight: "1.6" }}>
                    Consult our gynecologists and family planning specialists at Perungudi and Thalambur branches.
                  </p>
            ...
            <div className="grid-12">
              <div className="col-8">
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "1.5rem" }}>
                  {detailedServices.filter(s => {
                    if (category.id === "womens-health-gynecology") {
                      return ["gynecology-minimally-invasive-surgery", "fertility-preconception-care", "premarital-sexual-health-counselling", "hysteroscopy-advanced-uterine-care"].includes(s.slug);
                    }
                    if (category.id === "pregnancy-maternal-care") {
                      return ["high-risk-pregnancy-fetal-medicine", "pregnancy-scans-advanced-ultrasound", "fetal-medicine-in-utero-interventions"].includes(s.slug);
                    }
                    if (category.id === "diagnostics-testing") {
                      return ["diagnostic-imaging-scan-services", "advanced-genetic-prenatal-testing", "laboratory-clinical-testing"].includes(s.slug);
                    }
                    ...
                    <div key={s.slug} style={{
                      ...
                      <h4 style={{ fontFamily: "var(--font-heading)", fontSize: "1.35rem", color: "var(--dark-text)", marginBottom: "0.5rem" }}>
                        {s.title}
                      </h4>
                      <p style={{ fontSize: "0.95rem", color: "var(--body-text)", marginBottom: "1.5rem" }}>
                        {s.paragraphs[0]}
                      </p>
                      <Link key={s.slug} to={`/services/${s.slug}`} className="service-card-link">
                  ...
                  {category.id === "womens-health-gynecology" && (
                    <div style={{
                      ...
                      <p style={{ fontSize: "0.95rem", color: "var(--body-text)", marginBottom: "1.5rem" }}>
                        Family planning guidance and medical sterilization procedures tailored to patient goals.
                      </p>
                      <Link to="/services/family-planning-sterilisation" className="service-card-link">
                        <span>Read Verbatim Medical Guide</span>
                        <ChevronRight size={14} />
                      </Link>
                    </div>
              ...
              <div className="col-4">
                <div style={{
                  ...
                  <p style={{ fontSize: "0.95rem", color: "var(--body-text)", marginBottom: "1.5rem" }}>
                    Book appointment today to consult with our medical professionals about {category.title} services.
                  </p>
                  <Button to="/book-appointment" variant="primary" style={{ width: "100%" }}>
                    Book Appointment
                  </Button>
  ...
  const isScanOrDiagnostic = ["diagnostic-imaging-scan-services", "pregnancy-scans-advanced-ultrasound", "fetal-medicine-in-utero-interventions", "advanced-genetic-prenatal-testing", "laboratory-clinical-testing"].includes(targetSlug);
    ...
    <div className="service-detail-page" style={{ marginTop: "80px" }}>
      ...
      <section style={{
        ...
        <div className="container">
          ...
          <h1 style={{ fontFamily: "var(--font-heading)", fontSize: "var(--h1-fs)", marginTop: "1rem", lineHeight: "1.2" }}>
            {service.title}
          </h1>
          <p style={{ fontSize: "1.1rem", color: "var(--body-text)", maxWidth: "800px", marginTop: "1rem", lineHeight: "1.7" }}>
          ...
          <div className="grid-12">
            ...
            <div className="col-8">
              <div style={{ paddingRight: "2rem" }}>
                ...
                <div className="verbatim-article" style={{ lineHeight: "1.8", color: "var(--dark-text)" }}>
                  <h2 style={{ fontFamily: "var(--font-heading)", fontSize: "1.65rem", color: "var(--primary)", marginBottom: "2rem", lineHeight: "1.4" }}>
                    {service.articleTitle}
                  </h2>

                  {service.paragraphs.map((p, idx) => (
                    <p key={idx} style={{ marginBottom: "1.5rem", fontSize: "1.05rem", whiteSpace: "pre-line" }}>
                      {p}
                    </p>
                  ))}
                  ...
                  {service.sections.map((section, idx) => (
                    <div key={idx} style={{ marginTop: "3rem" }}>
                      ...
                      <p style={{ whiteSpace: "pre-line", fontSize: "1.05rem", marginBottom: "1.5rem" }}>
                        {section.content}
                      </p>
                    </div>
                  ))}
            ...
            <div className="col-4">
              <div className="sidebar-card">
                ...
                <p style={{ fontSize: "0.9rem", color: "var(--body-text)", marginBottom: "1.5rem", lineHeight: "1.6" }}>
                  Connect with our reproductive specialists, fetal medicine consultants, and obstetricians for personalized, evidence-based care.
                </p>
                
                <div style={{ marginBottom: "2rem", borderTop: "1px solid var(--border-light)", paddingTop: "1.5rem" }}>
                  <h4 style={{ fontSize: "0.8rem", textTransform: "uppercase", color: "var(--secondary)", marginBottom: "0.5rem" }}>
                    Clinically Integrated Services:
                  </h4>
                  <p style={{ fontSize: "0.85rem", color: "var(--dark-text)", margin: 0, lineHeight: "1.6" }}>
                    {service.combines}
                  </p>
                </div>
