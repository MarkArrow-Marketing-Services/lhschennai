...
import { ShieldCheck, Heart, CheckCircle2, ChevronRight, MapPin } from "lucide-react";
import { homeContent, doctorsData, clinicAboutData, serviceCategories, journeyTimeline, testimonialData, locationData, detailedServices } from "../data/contentData";
...
export default function Home() {
  ...
  return (
    <div className="home-page">
            ...
            <div className="hero-image-col">
              ...
              <div className="hero-card">
                ...
                <p className="hero-quote">
                  ...
                  Every journey to motherhood is unique—we’re with you at every step.
                </p>
              </div>
      ...
      <section className="stats-section section" style={{ borderTop: "1px solid var(--border-light)", background: "var(--white)" }}>
        <div className="container">
        ...
        <div className="container">
          <div className="grid-12 align-center">
            <div className="col-6 reveal">
              ...
              <h2 style={{ fontFamily: "var(--font-heading)", fontSize: "var(--h2-fs)", color: "var(--dark-text)", marginTop: "0.5rem" }}>
              ...
              <p style={{ color: "var(--body-text)", fontSize: "1rem", lineHeight: "1.8", marginBottom: "1.5rem" }}>
                {clinicAboutData.paragraphs[0]}
              </p>
              <p style={{ color: "var(--body-text)", fontSize: "0.95rem", lineHeight: "1.8", marginBottom: "2rem" }}>
                {clinicAboutData.paragraphs[1]}
              </p>
      ...
      <section className="services-section section" style={{ background: "var(--white)" }}>
        <div className="container">
          <SectionTitle 
            ...
            {serviceCategories.map((cat, idx) => (
              <div key={cat.id} className="col-3 reveal reveal-delay-1">
                <div className="home-category-card">
                  <h3 style={{ fontSize: "1.2rem", fontWeight: "600", color: "var(--primary)", marginBottom: "1.5rem" }}>
                    {cat.title}
                  </h3>
                  ...
                  <Link to={`/services/${cat.id}`} className="service-card-link" style={{ marginTop: "auto" }}>
      ...
      <section className="featured-combos section section-alt">
        <div className="container">
          ...
          <div className="grid-12">
            {detailedServices.slice(0, 3).map((svc, idx) => (
      ...
      {/* Doctors Section */}
      <section className="doctors-section section" id="doctors" style={{ background: "var(--white)" }}>
        <div className="container">
          <SectionTitle 
          ...
          <div className="grid-12 justify-center">
            {doctorsData.map((doc, idx) => (
              <div key={doc.id} className="col-6 reveal reveal-delay-1" style={{ maxWidth: "540px" }}>
                <DoctorCard 
                  id={doc.id}
                  name={doc.name}
                  title={doc.title}
                  profileSummary={doc.profile[0]}
                  qualifications={doc.sections[0].paragraphs[0].slice(0, 80) + "..."}
                  experience={doc.id === "dr-parimalam-ramanathan" ? "Over 30+ Years of Clinical Experience" : "Over 22+ Years of Clinical Practice"}
                />
              </div>
            ))}
          </div>
        ...
        <div className="container">
          ...
          <div className="timeline-container">
            ...
            {journeyTimeline.map((item, idx) => {
              ...
              return (
                <div key={idx} className={`timeline-item ${isEven ? "timeline-item-left" : "timeline-item-right"} reveal`}>
                  <div className="timeline-dot"></div>

                  <div className="timeline-content">
                    <span className="timeline-year">{item.year}</span>
                    <p style={{ margin: 0, fontSize: "0.95rem", color: "var(--body-text)", lineHeight: "1.6" }}>
                      {item.event}
                    </p>
                  </div>
                </div>
      ...
      {/* Testimonials */}
      <section className="testimonials-section section" style={{ background: "var(--white)" }}>
        <div className="container">
          <SectionTitle 
          ...
          <div className="grid-12">
            {testimonialData.map((t, idx) => (
              <div key={idx} className="col-6 reveal home-testimonial-card">
                <Heart size={36} color="var(--accent)" style={{ position: "absolute", right: "2rem", top: "2rem", opacity: 0.8 }} />
                <p style={{ fontStyle: "italic", fontSize: "1.05rem", color: "var(--dark-text)", marginBottom: "2rem", lineHeight: "1.8" }}>
                  “{t.text}”
                </p>
                <h4 style={{ fontSize: "1rem", color: "var(--primary)", margin: 0 }}>
                  - {t.patientName}
                </h4>
              </div>
            ))}
            ...
            {locationData.map((loc, idx) => (
              <div key={idx} className="col-6 reveal reveal-delay-1">
                <div className="home-location-card">
                  <div className="flex gap-2 align-center" style={{ color: "var(--primary)", marginBottom: "1.5rem" }}>
                    <MapPin size={24} />
                    <h3 style={{ margin: 0, fontSize: "1.45rem" }}>{loc.name}</h3>
                  </div>
                  <p style={{ fontSize: "1rem", color: "var(--dark-text)", fontWeight: "500", marginBottom: "1rem" }}>
                    {loc.address}
                  </p>
                  <p style={{ fontSize: "0.95rem", color: "--body-text", marginBottom: "1.5rem", lineHeight: "1.7" }}>
                    {loc.details}
                  </p>
                  <p style={{ fontSize: "0.9rem", color: "var(--primary)", margin: 0 }}>
      ...
      <section className="insights-section section" style={{ background: "var(--white)" }}>
        <div className="container">
          <SectionTitle 
