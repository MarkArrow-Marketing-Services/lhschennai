...
export default function Home() {
  ...
  return (
    <>
      <Helmet>
        <title>
          Best IVF Centre in OMR Chennai | London Harley Street Women
        </title>
        <meta
          name="description"
          content="Best IVF and fertility centre in Chennai OMR. London Harley Street Women & Fertility Centre in Perungudi and Thalambur provides advanced fertility and women's healthcare"
        />
      </Helmet>
              ...
              <div className="hero-image-col">
                ...
                <div className="hero-card">
                  ...
                  <p className="hero-quote">
                    ...
                    Every journey to motherhood is unique—we’re with you at
                    every step.
                  </p>
                </div>
