    ...
    <div className="about-page" style={{ marginTop: "80px" }}>
      ...
      <section className="page-hero">
        <div className="container">
          ...
          <p>
            delivering exceptional, patient-focused health care at each stage of
            life prioritising women's health, dignity, and well-being.
          </p>
        </div>
      </section>
        ...
        <div className="container">
          <div className="grid-12 align-center">
            ...
            <div className="col-5 about-mission-box">
              ...
              >
                With a vision centered prioritizing the women's health, dignity,
                and well-being. The London Harley Street Women and Fertility
                Centre was established to deliver exceptional, patient-focused
                health care at each stage of life. We address the scientific and
                medical solutions of women including reproductive health to
                pregnancy, fertility etc.., and we treat every patient with
                empathy, respect, and confidentiality, ensuring a comfortable
              ...
              >
                ...
                deeply connected to emotional and mental well-being, we empower
                the awareness, and preventive care, and providing continuous
