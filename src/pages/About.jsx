...
export default function About() {
  ...
  return (
    <>
      <Helmet>
        <title>
          Fertility Specialist in Chennai | Dr. Parimalam Ramanathan
        </title>
        <meta
          name="description"
          content="Meet Dr. Parimalam Ramanathan, a leading fertility specialist in Chennai, offering IVF, fertility treatment, preconception care and women's health services"
        />
      </Helmet>
      <div className="about-page" style={{ marginTop: "80px" }}>
        ...
        <section className="page-hero">
          <div className="container">
            ...
            <p>
              delivering exceptional, patient-focused health care at each stage
              of life prioritising women's health, dignity, and well-being.
            </p>
          </div>
        </section>
          ...
          <div className="container">
            <div className="grid-12 align-center">
              ...
              <div className="col-5 about-mission-box">
                ...
                >
                  With a vision centered prioritizing the women's health,
                  dignity, and well-being. The London Harley Street Women and
                  Fertility Centre was established to deliver exceptional,
                  patient-focused health care at each stage of life. We address
                  the scientific and medical solutions of women including
                  reproductive health to pregnancy, fertility etc.., and we
                  treat every patient with empathy, respect, and
                  confidentiality, ensuring a comfortable and supportive
                  environment.
                </p>
                <p
                  style={{
                ...
                >
                  We specialize in gynecology, obstetrics, and fertility medical
                  services, including IVF. Understanding that women’s health is
                  deeply connected to emotional and mental well-being, we
                  empower the awareness, and preventive care, and providing
                  continuous support, at each stage of life.
                </p>
              </div>
            </div>
          </div>
            ...
            {doctorsData.map((doc, idx) => (
              <div key={doc.id} id={doc.id} className="doc-profile-card">
                <div className="grid-12">
                  ...
                  <div className="col-7">
                    <h3 style={{ fontSize: "1.45rem", marginBottom: "1rem" }}>
                      Biography
                    </h3>
                      ...
                      <div className="doc-timeline-wrapper">
                        <div className="doc-timeline-intro">
                          ...
                          {doc.timelineIntro.map((line, lineIdx) => (
                            <p
                              key={lineIdx}
                              className="doc-timeline-intro-text"
                            >
                              {line}
                            </p>
                          ))}
          ...
          <div className="container">
            ...
            <div className="grid-12">
              <div className="col-4 about-why-card">
                ...
                >
                  Inspired by the renowned London Harley Street model of
                  evidence-based and ethical care, bringing global expertise
                  directly to OMR Chennai.
                </p>
              </div>
              ...
              <div className="col-4 about-why-card">
                ...
                >
                  Combining clinical precision with complete emotional support.
                  Providing a comfortable, private and safe environment for
              ...
              <div className="col-4 about-why-card">
                ...
                >
                  Doctors with over 30+ years of UK NHS and leading hospital
                  experience, certified by international foundations and Royal
                  Colleges.
                </p>
              </div>
            </div>
